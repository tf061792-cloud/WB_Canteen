...
export default function LanguageSelector() {
  ...
  return (
    <div className="relative group">
      <button className="flex items-center gap-2 px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-lg transition-colors bg-white shadow-sm border">
        <span className="text-lg">
          {languages.find(l => l.code === i18n.language)?.flag || '🇨🇳'}
        </span>
        <span className="hidden sm:inline">{languages.find(l => l.code === i18n.language)?.label || '中文'}</span>
